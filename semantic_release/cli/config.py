...
class ChangelogConfig(BaseModel):
    ...
    # @field_validator("default_templates", mode="before")
    # @classmethod
    # def load_default_on_missing(cls, val: Any) -> Any:
    #     overrides = {} if not isinstance(val, dict) else val
    #     return DefaultChangelogTemplatesConfig.model_validate(overrides)
